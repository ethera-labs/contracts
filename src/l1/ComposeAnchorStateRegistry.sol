...
contract ComposeAnchorStateRegistry is ProxyAdminOwnedBase, Initializable, ReinitializableBase, ISemver {
    ...
    /// @notice SuperchainConfig contract used for guardian and pause checks.
    ...
    /// @param _startingRespectedGameType The initial respected game type.
    function initialize(
    ...
    function paused() public view returns (bool) {
        // Pause if the ComposeASR is paused or global superchain pause is active.
