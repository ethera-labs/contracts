...
contract MigrateRollupV3 is Script {
    ...
    function run(bool _dryRun) public returns (MigrateRollupOutput) {
        dryRun = _dryRun;
    ...
    function loadConfiguration() internal returns (MigrateRollupInput) {
        ...
        migrationInput.set(migrationInput.composeDisputeGameFactory.selector, ComposeConfig.disputeGameFactory());
        ...
        migrationInput.set(migrationInput.proofMaturityDelaySeconds.selector, ComposeConfig.proofMaturityDelaySeconds());
